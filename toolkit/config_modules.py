...
class TrainConfig:
    def __init__(self, **kwargs):
        ...
        # 'object' = editing losses (funcs.py), 'texture' = spectral/texture losses, None = standard
        self.training_mode: Optional[str] = kwargs.get('training_mode', None)
        ...
        self.local_patch_size = kwargs.get('local_patch_size', 192)
        self.local_stride = kwargs.get('local_stride', 96)
        self.local_min_coverage = kwargs.get('local_min_coverage', 0.45)
        self.local_hard_k_frac = kwargs.get('local_hard_k_frac', 0.30)
        self.local_hard_k_min = kwargs.get('local_hard_k_min', 4)
        ...
        self.loss_seamless_coef = kwargs.get('loss_seamless_coef', 0.0)
        self.loss_gradient_coef = kwargs.get('loss_gradient_coef', 0.0)
        self.loss_cross_patch_coef = kwargs.get('loss_cross_patch_coef', 0.0)
        self.loss_multiscale_coef = kwargs.get('loss_multiscale_coef', 0.0)
        self.loss_latent_period_coef = kwargs.get('loss_latent_period_coef', 0.0)
        self.loss_anchor_coef = kwargs.get('loss_anchor_coef', 0.0)
        ...
        self.seamless_check_diagonals = kwargs.get('seamless_check_diagonals', True)
        self.seamless_diagonal_weight = kwargs.get('seamless_diagonal_weight', 0.5)
        ...
        # funcs.py editing losses (identity, geometry, overlay, contrastive, multi_neg) — for Flux Kontext
        self.funcs_identity_weight = kwargs.get('funcs_identity_weight', 0.0)
        self.funcs_geometry_weight = kwargs.get('funcs_geometry_weight', 0.0)
        self.funcs_overlay_weight = kwargs.get('funcs_overlay_weight', 0.0)
        self.funcs_contrastive_weight = kwargs.get('funcs_contrastive_weight', 0.0)
        self.funcs_multi_neg_weight = kwargs.get('funcs_multi_neg_weight', 0.0)
        self.funcs_margin = kwargs.get('funcs_margin', 0.2)
        self.funcs_geometry_kind = kwargs.get('funcs_geometry_kind', 'l2')  # l2, l1, cos
        self.funcs_contrastive_dist = kwargs.get('funcs_contrastive_dist', 'cos')  # cos, l2
